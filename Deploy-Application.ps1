...
Try {
	...
	[string]$appVendor = 'Lingo'
	[string]$appName = '16'
	[string]$appVersion = 'License - Expires May 2018'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/25/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirSupportFiles\lndlng16.lic" -Destination "$envProgramFiles\LINGO64_16\lndlng16.lic"
		
		##$exitCode = Execute-Process -Path "$dirFiles\minitab18.1.0.0setup.exe" -Parameters "/exenoui /exelang 1033 /qn ACCEPT_EULA=1 LICENSE_SERVER=vmwas22.winad.msudenver.edu LICENSE_SERVER_PORT=27090 DISABLE_UPDATES=1" -WindowStyle "Hidden" -PassThru
